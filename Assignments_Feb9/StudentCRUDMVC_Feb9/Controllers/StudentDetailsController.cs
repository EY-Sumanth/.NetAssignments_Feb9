...
using StudentCRUDMVC_Feb9.Models;

namespace StudentCRUDMVC_Feb9.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,StudentAge,StudentAddress,CourseId")] StudentDetail studentDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,StudentAge,StudentAddress,CourseId")] StudentDetail studentDetail)
        {
