...
namespace StudentCRUDMVC_Feb9.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseId,CourseName,CourseFee,CourseResult")] CourseDetail courseDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,CourseName,CourseFee,CourseResult")] CourseDetail courseDetail)
        {
