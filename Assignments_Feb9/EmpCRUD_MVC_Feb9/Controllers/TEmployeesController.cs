...
namespace EmpCRUD_MVC_Feb9.Controllers
{
    public class TEmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,EmployeeName,EmployeeAge,EmployeeSalary,EmployeeDesignation,EmployeeAddress")] TEmployee tEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeName,EmployeeAge,EmployeeSalary,EmployeeDesignation,EmployeeAddress")] TEmployee tEmployee)
        {
